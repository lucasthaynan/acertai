...
function exibirDicaCarta(numeroDica) {
    ...
    document.querySelector("section.select-tips .container.tip").display.style = "flex"

    setTimeout(function() {
        document.querySelector("section.select-tips .container.tip").display.style = "none"
